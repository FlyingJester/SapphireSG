...
struct SapphireSG_Context {
	...
	struct SapphireSG_VertexShader *(*CreateVertexShader)(struct SapphireSG_Context *ctx);
	struct SapphireSG_FragmentShader *(*CreateFragmentShader)(struct SapphireSG_Context *ctx);
