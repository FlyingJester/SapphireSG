...
static void OpenGLExtraProgramUniform1f(GLuint prog, GLint loc, GLfloat v0) {
...
static void OpenGLExtraProgramUniform2f(GLuint prog, GLint loc, GLfloat v0, GLfloat v1) {
	GLint original_program;
	glGetIntegerv(GL_CURRENT_PROGRAM, &original_program);
...
static void OpenGLExtraProgramUniform3f(GLuint prog, GLint loc, GLfloat v0, GLfloat v1, GLfloat v2) {
	GLint original_program;
	glGetIntegerv(GL_CURRENT_PROGRAM, &original_program);
...
fprintf(stderr, "[OpenGLExtra] Init Error: " NAME " is not present in OpenGL library.\n");\
exit(1);\
}\
}
...
void OpenGLExtra_LoadGLFunctions(void *(*OpenGL_LoadProcAddres)(const char *)) {
	...
	if (OpenGL_LoadProcAddres == NULL) {
		...
		OpenGL_LoadProcAddres = wglGetProcAddress;
#endif
	...
	GET_GL_FUNCTION_NON_FATAL(glEnableVertexAttribArray, (void (APIENTRY *)(GLuint)));
	...
	GET_GL_FUNCTION_NON_FATAL_ALTERNATIVE(glProgramUniform1f, 
		(void (APIENTRY *)(GLuint, GLint, GLfloat)), OpenGLExtraProgramUniform1f);
	GET_GL_FUNCTION_NON_FATAL_ALTERNATIVE(glProgramUniform2f, 
		(void (APIENTRY *)(GLuint, GLint, GLfloat, GLfloat)), OpenGLExtraProgramUniform2f);
	GET_GL_FUNCTION_NON_FATAL_ALTERNATIVE(glProgramUniform3f, 
		(void (APIENTRY *)(GLuint, GLint, GLfloat, GLfloat, GLfloat)), OpenGLExtraProgramUniform3f);
}
